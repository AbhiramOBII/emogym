        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid lg:grid-cols-2 gap-12">
                ...
                <div class="bg-dark-surface p-8 rounded-lg">
                    <h2 class="text-2xl font-semibold text-dark-text mb-6">Get in Touch</h2>
                    <form class="space-y-6">
                        <div>
                            <label for="name" class="block text-dark-text mb-2">Name</label>
                        ...
                        <div>
                            <label for="email" class="block text-dark-text mb-2">Email</label>
                        ...
                        <div>
                            <label for="phone" class="block text-dark-text mb-2">Phone</label>
                        ...
                        <div>
                            <label for="message" class="block text-dark-text mb-2">Message</label>
                ...
                <div class="space-y-8">
                    <div class="bg-dark-surface p-8 rounded-lg">
                        <h2 class="text-2xl font-semibold text-dark-text mb-6">Contact Information</h2>
                        <div class="space-y-4">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    <p class="text-dark-text font-semibold">Phone</p>
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    <p class="text-dark-text font-semibold">Email</p>
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    <p class="text-dark-text font-semibold">Address</p>
                    ...
                    <div class="bg-dark-surface p-8 rounded-lg">
                        <h3 class="text-xl font-semibold text-dark-text mb-4">Office Hours</h3>
