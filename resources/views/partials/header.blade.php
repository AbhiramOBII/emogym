        ...
        <div class="flex justify-between items-center">
            ...
            <nav class="hidden md:flex items-center">
                <ul class="flex items-center list-none gap-8 m-0 p-0">
                    ...
                    <li><a href="{{ route('programs.upcoming') }}" class="text-dark-text no-underline font-semibold hover:text-primary transition-colors duration-300 relative group" style="font-size: 17px;">{{ __('navigation.upcoming') }}<span class="absolute w-0 h-0.5 bottom-[-5px] left-0 bg-primary transition-all duration-300 group-hover:w-full"></span></a></li>
                ...
                <div class="absolute right-0 top-0 h-full w-80 max-w-[80vw] bg-dark-card shadow-2xl transform translate-x-full transition-transform duration-300 overflow-y-auto">
                    ...
                    <div class="p-8 pt-16">
                        <ul class="flex flex-col list-none gap-6 m-0 p-0">
                            ...
                            <li><a href="{{ route('programs.upcoming') }}" class="text-dark-text no-underline font-medium text-lg hover:text-primary transition-colors duration-300 block py-2">{{ __('navigation.upcoming') }}</a></li>
